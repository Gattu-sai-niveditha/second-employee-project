		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Employee",
									"targetURL": "#uiMySecondEmployeesecondemployeeproject-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"uiMySecondEmployeesecondemployeeproject-display": {
								"semanticObject": "uiMySecondEmployeesecondemployeeproject",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=ui.MySecondEmployee.secondemployeeproject",
									"url": sap.ui.require.toUrl("ui/MySecondEmployee/secondemployeeproject")
								}
							}
						}
					}
